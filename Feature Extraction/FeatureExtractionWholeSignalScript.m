...
varnames = ["maxArea","totalArea","ellipse_similarity_ratio",...
            "noPeaks","belongs46","power46", "bspecEn12h8",...
            "bspecEn22h8","totalBic2h8","bicEn12h8","bicEn22h8","class"];
...
for i = 1:length(situations)
    ...
    for j = 1:2
        ...
        Features1 = [matrixArea,matrixtotalArea,...
