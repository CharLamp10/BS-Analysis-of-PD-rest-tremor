...
function Peaks = findPeaksTest(xcoord, ycoord, Bispec)
...
%% Inputs:
% xcoord    -double array. The x coordinates of the posible peaks
% ycoord    -double array. The y coordinates of the posible peaks
% Bispec    -double matrix. The bispectrum
%% Outputs:
% Peaks     -double matrix. The coordinates of the peaks
%
%-----------------------------------------------------------------------------------------------------------------
