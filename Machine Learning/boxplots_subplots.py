...
ax.set_ylabel(plot_labels[0],fontsize = 38)
ax.set_xlabel("class",fontsize = 0)
ax.tick_params(labelsize = 33)
    
ax = fig.add_subplot(2, 2, 3)
sb.boxplot(x="class", y=features[1], data=dataset)
ax.set_ylabel(plot_labels[1],fontsize = 38)
ax.set_xlabel("class",fontsize = 0)
ax.tick_params(labelsize = 33)
    
ax = fig.add_subplot(2, 2, 4)
sb.boxplot(x="class", y=features[2], data=dataset)
ax.set_ylabel(plot_labels[2],fontsize = 38)
ax.set_xlabel("class",fontsize = 0)
ax.tick_params(labelsize = 33)
...
ax.set_ylabel(plot_labels[3],fontsize = 38)
ax.set_xlabel("Med",fontsize = 0)
ax.tick_params(labelsize = 33)
